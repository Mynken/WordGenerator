...
namespace Wordgenerator.Controllers
{
    ...
    {
        public HttpResponseMessage Post([FromBody]DocumentIEModel data)
        {
            try
            {
                var generator = new WordIEGenerator();
                ...
                if(data.DataForDoc.IsPdf)
                {
                    ...
                    picture.VerticalPosition = -77;
                    picture.HorizontalPosition = -10;
