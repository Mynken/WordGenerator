...
{
    public class WordLLCGenerator
    {
        public string CreateIEDocument(KontrahentLLC kontrahent, Film film, ModelDoc dataForDoc, List<Trailer> trailers, string path)
        {
            ...
            document.InsertParagraph("Фізична особа-підприємець " + kontrahent.FullName)
              .Font(new Xceed.Words.NET.Font("Cambria"))
              .FontSize(pageSize)
              .Bold()
